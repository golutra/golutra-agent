...
use golutra_agent_core::{ProviderRequestId, ToolCallId, ToolProgress};
use golutra_agent_llm::ProviderStreamEvent;
use golutra_agent_runtime::RuntimeObservation;
...
fn pending_turn_bytes(turn: &golutra_agent_runtime::PendingAgentTurn) -> usize {
    structured_bytes(&(
        turn.command_id,
        turn.turn_id,
        &turn.content,
...
mod tests {
    ...
    use golutra_agent_runtime::RuntimeObservation;
    use golutra_agent_tools::{BasicToolExecutor, ToolRequest};
    use serde_json::json;
    ...
    async fn critical_events_flush_pending_streams_in_order() {
        ...
        sender
            .send(RuntimeObservation::AssistantMessage {
                turn_id: golutra_agent_core::TurnId::new(),
