...
use golutra_agent_protocol::{RuntimeEvent, RuntimeEventType as ProtocolRuntimeEventType};
...
struct DurableTurnJournal {
    ...
    checkpoint_event_refs: Vec<golutra_agent_core::EventId>,
...
mod tests {
    use super::*;
    use golutra_agent_core::{EventId, Timestamp};
