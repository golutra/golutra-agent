...
use golutra_agent_protocol::{DebugProjection, RuntimeQuery, RuntimeQueryKind};
use golutra_agent_vis::{audit_report, load_all_events, otel_trace};

#[derive(Debug, Parser)]
#[command(name = "golutra-agent-vis")]
#[command(version)]
