...
use golutra_agent_client::{EmbeddedTransport, RuntimeClient, projection_status};
use golutra_agent_core::{Actor, ActorKind, CommandId, QueryId, TaskStatus};
...
pub async fn transport_smoke() -> miette::Result<bool> {
    ...
    let command = SessionCommand {
        ...
        actor: Actor {
            kind: ActorKind::Sdk,
            id: "golutra-agent-test-client".to_owned(),
        },
...
mod tests {
    ...
    use golutra_agent_client::RuntimeEventStream;
    use golutra_agent_core::SessionId;
    use golutra_agent_protocol::{EventFilter, RuntimeEventType};
