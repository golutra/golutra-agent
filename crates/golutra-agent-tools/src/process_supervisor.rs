...
use golutra_agent_sandbox::{SandboxBackendKind, SandboxRequest, SystemSandbox, WorkspaceAccess};
#[cfg(unix)]
use nix::libc;
...
pub(crate) struct ProcessSnapshot {
    ...
    pub(crate) sandbox_backend: golutra_agent_sandbox::SandboxBackendKind,
...
struct ManagedProcess {
    ...
    sandbox_backend: golutra_agent_sandbox::SandboxBackendKind,
