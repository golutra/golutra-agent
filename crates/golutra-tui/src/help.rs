...
pub(crate) fn help_lines(topic: HelpTopic, keymap: KeymapMode, context: &str) -> Vec<String> {
    match topic {
        ...
        HelpTopic::Navigation => vec![
            "PageUp/PageDown  scroll the focused pane".to_owned(),
            "Home/End         oldest or latest visible content".to_owned(),
            "F6 or Tab        switch transcript/developer focus".to_owned(),
            "Ctrl+T           transcript fullscreen".to_owned(),
            ...
            "Mouse wheel      scroll the pane under the pointer".to_owned(),
            "Mouse click      focus panes and select visible choices".to_owned(),
        ],
        HelpTopic::Runtime => vec![
            ...
            "/debug           developer runtime facts".to_owned(),
            String::new(),
        ...
        HelpTopic::WhatsNew => vec![
            ...
            String::new(),
            "- Responsive wrapped transcript and developer facts".to_owned(),
