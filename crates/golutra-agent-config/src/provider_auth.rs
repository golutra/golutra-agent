...
use golutra_agent_auth::{OAuthFlow, OAuthProviderDescriptor, OpenAiDeviceAuthorizationDescriptor};
...
fn openai_chatgpt_descriptor() -> OAuthProviderDescriptor {
    OAuthProviderDescriptor {
        ...
        authorization_params: BTreeMap::from([
            ...
            ("originator".to_owned(), "golutra-agent".to_owned()),
        ]),
...
fn xai_descriptor() -> OAuthProviderDescriptor {
    OAuthProviderDescriptor {
        ...
        authorization_params: BTreeMap::from([
            ...
            ("referrer".to_owned(), "golutra-agent".to_owned()),
        ]),
