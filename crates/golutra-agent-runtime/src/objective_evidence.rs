...
use golutra_agent_core::{TaskContract, ToolResultStatus, VerificationRequirement};
use golutra_agent_policy::parse_shell_command_with_input;
use golutra_agent_tools::{ToolExecutionReport, ToolRequest, redact_sensitive_text};
use regex::Regex;
...
const TRUSTED_TEST_EXECUTION_FACT: &str = "golutra_agent_test_execution";
