...
use golutra_agent_verify::{VerificationInput, VerificationRunner};
...
#[cfg(test)]
mod tests {
    use golutra_agent_core::{TaskClass, VerificationDimensionStatus};
    ...
    fn analysis_contract_does_not_infer_effects_from_prompt_words() {
        for objective in [
            ...
            let evidence = golutra_agent_core::EvidenceId::new();
            let input = VerificationInput {
                task_id: TaskId::new(),
