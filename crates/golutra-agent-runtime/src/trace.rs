...
use golutra_agent_context::ContextCompactionRecord;
...
use golutra_agent_governor::RuntimeGovernorDecision;
use golutra_agent_llm::{ProviderRequest, ProviderResponse, ProviderStreamEvent};
...
pub enum AgentLoopTraceEvent {
    ...
    PolicyEvaluated(golutra_agent_core::PolicyEvaluation),
    ...
    LoopGuardTriggered {
        trigger: golutra_agent_core::LoopGuardTrigger,
        reason: String,
    },
