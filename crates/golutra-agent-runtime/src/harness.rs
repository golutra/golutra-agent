...
use golutra_agent_llm::{LlmProvider, PromptCacheScope};
use golutra_agent_protocol::{AgentExecutionMode, AgentToolProfile};
use golutra_agent_tools::ToolRuntime;
    ...
    P: LlmProvider,
{
    ...
    #[must_use]
    pub fn with_governor(mut self, governor: golutra_agent_governor::RuntimeGovernor) -> Self {
    ...
    pub fn with_external_verifiers(
        mut self,
        external_verifiers: Vec<golutra_agent_protocol::ExternalVerificationSpec>,
    ) -> Self {
    ...
    pub fn with_max_elapsed_ms(mut self, max_elapsed_ms: u64) -> Self {
        ...
        self.loop_core_mut().governor = golutra_agent_governor::RuntimeGovernor::new(limits);
        self
    }
