...
use golutra_agent_protocol::TaskTracePage;
use golutra_agent_supervisor::{
...
#[derive(Debug, Parser)]
#[command(name = "golutra-agent-supervisor")]
#[command(version)]
#[command(about = "Golutra governed evolution and release control plane")]
struct Cli {
    #[arg(long, env = "GOLUTRA_AGENT_SUPERVISOR_HOME")]
    root: PathBuf,
    #[arg(long, env = "GOLUTRA_AGENT_RELEASE_HOME")]
    releases: PathBuf,
    #[command(subcommand)]
    command: Command,
}
