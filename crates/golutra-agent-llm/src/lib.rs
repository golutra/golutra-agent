...
use golutra_agent_auth::{CredentialProvider, FixedCredentialProvider};
...
pub use golutra_agent_core::{ProviderUsage, UsageSource};
...
const GOLUTRA_AGENT_PROVIDER_PROTOCOL: &str = "GOLUTRA_AGENT_PROVIDER_PROTOCOL";
const GOLUTRA_AGENT_PROVIDER_API_KEY: &str = "GOLUTRA_AGENT_PROVIDER_API_KEY";
const GOLUTRA_AGENT_PROVIDER_API_KEY_ENV: &str = "GOLUTRA_AGENT_PROVIDER_API_KEY_ENV";
const GOLUTRA_AGENT_PROVIDER_MODEL: &str = "GOLUTRA_AGENT_PROVIDER_MODEL";
const GOLUTRA_AGENT_PROVIDER_BASE_URL: &str = "GOLUTRA_AGENT_PROVIDER_BASE_URL";
const GOLUTRA_AGENT_PROVIDER_GENERATION_CONFIG: &str = "GOLUTRA_AGENT_PROVIDER_GENERATION_CONFIG";
pub const GOLUTRA_AGENT_PROVIDER_CUSTOM_HEADERS: &str = "GOLUTRA_AGENT_PROVIDER_CUSTOM_HEADERS";
/// 非敏感的 provider route identity；只用于声明能力选择，不包含凭据或用户内容。
pub const GOLUTRA_AGENT_PROVIDER_ROUTE_ID: &str = "GOLUTRA_AGENT_PROVIDER_ROUTE_ID";
/// 非敏感的缓存能力声明；由配置层传入，适配器只执行声明而不猜测网关能力。
pub const GOLUTRA_AGENT_PROVIDER_CACHE_CAPABILITIES: &str =
    "GOLUTRA_AGENT_PROVIDER_CACHE_CAPABILITIES";
const GOLUTRA_AGENT_PROVIDER_AUTH_PROVIDER: &str = "GOLUTRA_AGENT_PROVIDER_AUTH_PROVIDER";
...
impl OpenAiCompatibleProvider {
        ...
        let builder = if self.provider_id == "github-copilot" {
            builder
                .header(
                    ...
                    format!("golutra-agent/{}", env!("CARGO_PKG_VERSION")),
                )
        ...
        F: Fn(&str) -> Option<String>,
    {
        ...
        let provider_id = reader(GOLUTRA_AGENT_PROVIDER_AUTH_PROVIDER)
            .filter(|value| !value.trim().is_empty())
            .or_else(|| {
                reader(GOLUTRA_AGENT_PROVIDER_ROUTE_ID).filter(|value| !value.trim().is_empty())
            })
        ...
        Self {
            providers: vec![
                ...
                ProviderConfig {
                    ...
                    auth_env: Some("GOLUTRA_AGENT_PROVIDER_API_KEY".to_owned()),
...
pub(crate) const WEB_SEARCH_WIRE_ALIAS: &str = "golutra_agent_web_search";
