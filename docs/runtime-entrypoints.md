...
`network.enabled=false` as OS-enforced network isolation in yolo mode. A queued
turn inherits the active task's mode and cannot switch it. Outside-workspace
