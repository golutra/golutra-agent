...
class GolutraClient:
    ...
    def _request(
        ...
        headers = {
            ...
            "x-golutra-agent-actor-id": self._actor_id,
            "x-golutra-agent-protocol-version": str(RUNTIME_PROTOCOL_VERSION),
        }
        if attached:
            headers["x-golutra-agent-attachment"] = self._runtime_attachment()["attachment_id"]
